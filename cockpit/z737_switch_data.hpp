...
//		SwitchCommands lower_du_fo{2, std::vector<CommandRefName>{CommandRefName::lower_du_fo_right, CommandRefName::lower_du_fo_left}};
		...
		SwitchCommands starter1_pos{2, std::vector<CommandRefName>{CommandRefName::eng1_start_right, CommandRefName::eng1_start_left }};
		SwitchCommands starter2_pos{2, std::vector<CommandRefName>{CommandRefName::eng2_start_right, CommandRefName::eng2_start_left }};
