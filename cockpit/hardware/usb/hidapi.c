...
HID_API_EXPORT
*
HID_API_CALL hid_enumerate(unsigned short vendor_id, unsigned short product_id)
{
    BOOL res;
...
// Open the device.
	int handle = open(VendorID, ProductID, "12345");
	if (handle < 0)
