...
namespace zcockpit::cockpit::hardware
{
	...
	MIPioCards::MIPioCards(std::string deviceBusAddr)
	...
	void MIPioCards::updateRelays(int state)
	{
	...
	void MIPioCards::processOutputs()
	{
