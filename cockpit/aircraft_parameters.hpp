...
//		CommandRefName::lower_du_fo_right,
		...
		CommandRefName::flaps_0,
		CommandRefName::flaps_1,
		CommandRefName::flaps_2,
		CommandRefName::flaps_5,
		CommandRefName::flaps_10,
		CommandRefName::flaps_15,
		CommandRefName::flaps_25,
		CommandRefName::flaps_30,
		CommandRefName::flaps_40,
		CommandRefName::mixture1_idle,
		CommandRefName::mixture1_cutoff,
		CommandRefName::mixture2_idle,
		CommandRefName::mixture2_cutoff,
		CommandRefName::left_toga_press,
		CommandRefName::gear_horn_cutout,
		CommandRefName::ap_trim,
		CommandRefName::el_trim,
		CommandRefName::ap_trim_lock,
		CommandRefName::el_trim_lock,
